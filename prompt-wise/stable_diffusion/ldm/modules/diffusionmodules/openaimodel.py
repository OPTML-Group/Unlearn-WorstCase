...
class ResBlock(TimestepBlock):
    ...
    def __init__(
        ...
        )  # if out_channels is None then keep the input channel number unchanged.
        self.use_conv = use_conv
        ...
        self.updown = (
            up or down
        )  # this is to identify whether the feature map size changes or not
    ...
    def __init__(
        ...
        for level, mult in list(enumerate(channel_mult))[::-1]:
            for i in range(self.num_res_blocks[level] + 1):
                ...
                ):  # note ds loops following [8, 4, 2, 1], a reverse order of the input_blocks
                    if num_head_channels == -1:
                        dim_head = ch // num_heads
                    else:
                        num_heads = ch // num_head_channels
        ...
        self.out = nn.Sequential(
            ...
            ),  # input_channels: model_channels, output_channels: out_channels
        )
